...
// Based off IArmorMaterial.Java
public enum ModArmorMaterial implements IArmorMaterial {
    ENDER_GEM("ender_gem", 42, new int[]{4, 7, 10, 4}, 17,
            SoundEvents.ITEM_ARMOR_EQUIP_DIAMOND, 3.7F, 0.2F,
    ...
    public String getName() {
        return EmbeddedEnder.MOD_ID + ":" + this.name;
    }
