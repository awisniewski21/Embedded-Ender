...
// Based off ChickenEntity.java
public class EnderChickenEntity extends AnimalEntity {
    ...
    public EnderChickenEntity createChild(ServerWorld world, AgeableEntity mate) {
        return ModEntityTypes.ENDER_CHICKEN.get().create(world);
    }
