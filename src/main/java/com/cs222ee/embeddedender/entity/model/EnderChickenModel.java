...
// Based off ChickenModel.Java
public class EnderChickenModel<T extends EnderChickenEntity> extends ChickenModel<T> {
    ...
    public void setLivingAnimations(EnderChickenEntity livingBase, float limbSwing, float limbSwingAmount, float partialTicks) {
